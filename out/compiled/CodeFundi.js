var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 1 && raw_value !== (raw_value = /*message*/ ctx[6] + "")) div.innerHTML = raw_value;		},
    		d: function destroy(detaching) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*fundiDebug*/ ctx[2], false, false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function debug() {
    		tsvscode.postMessage({ type: 'debug', value: newMessage });
    	}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<CodeFundi> was created with unknown prop '${key}'`);
    	});
    	...
    	return [messages, newMessage, fundiDebug, input_input_handler, submit_handler];
    }
